  ...
  >
    ...
    <div
      ...
      style={{
        ...
        background: "#23263a",
        borderRadius: 10,
        boxShadow: "0 2px 16px rgba(40,40,80,0.12)",
        padding: 8,
      }}
    >
      <table
      ...
      >
        <thead>
          ...
          >
            <th style={{ textAlign: "center", padding: "0.7em 0.3em" }}>
              Status
            </th>
        ...
        <tbody>
          {companies.map(company => (
            <tr
              key={company.id}
              style={{
                borderBottom: "1px solid #393c5a",
                background: "#23263a",
                transition: "background 0.2s",
              }}
              onMouseEnter={e =>
                (e.currentTarget.style.background = "#282a3d")
              }
              onMouseLeave={e =>
            ...
            >
              ...
              <td style={{ padding: "0.6em 0.3em" }}>
                <button
                  ...
                  style={{
                    background:
                      "linear-gradient(90deg, #ff6b81 0%, #ffb6b6 100%)",
                    color: "#fff",
                    border: "none",
                    borderRadius: 6,
                    padding: "0.4em 1em",
                            ...
                            >
                              ...
                              <td>
                                ...
                                {h.incidentAt && (
                                  <div style={{ color: "#888" }}>
                                    Incident Time:{" "}
                                    {new Date(h.incidentAt).toLocaleString()}
                                  </div>
                                )}
                              </td>
                            </tr>
